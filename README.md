...
```
# =============================================================================
# hosts.conf – AUTO-GENERATED by Manage-DefenderOffline.ps1 v0.0.6
...
.\Manage-DefenderOffline.ps1 -SaveSmtpCredential
```
...
pwsh.exe -File .\Manage-DefenderOffline.ps1 `
    -SourceSharePath "\\fileserver\updates" `
    -MpamFileName "mpam-feX64.exe" `
    -ParallelThreads 32
```
...
4. **File Transfer** (5-15 sec, depends on network speed)
   - Create temp folder on target: `C:\Temp\Manage-DefenderOffline\`
...
**Primary log:** `C:\Logs\Manage-DefenderOffline_YYYYMMDD_HHmmss.log`
...
| `-TempFolderOnTarget` | string | `C:\Temp\Manage-DefenderOffline` | Temp directory on remote systems |
...
**Get full help:**
```powershell
Get-Help .\Manage-DefenderOffline.ps1 -Full
```
...
.\Manage-DefenderOffline.ps1 ... -ParallelThreads 8

# Increase threads if network has capacity
.\Manage-DefenderOffline.ps1 ... -ParallelThreads 24
...
```powershell
Get-Help .\Manage-DefenderOffline.ps1 -Examples
```

**View all parameters:**
```powershell
Get-Help .\Manage-DefenderOffline.ps1 -Parameter *
```

**Check script version:**
```powershell
# Look for version in log header
Get-Content "C:\Logs\Manage-DefenderOffline_*.log" -First 5
```

**Enable verbose logging:**
```powershell
.\Manage-DefenderOffline.ps1 ... -Verbose
```
...
**💬 Questions? Open a [discussion](https://github.com/kismetgerald/Manage-DefenderOffline/discussions)**

**🐛 Found a bug? [Report it](https://github.com/kismetgerald/Manage-DefenderOffline/issues)**
